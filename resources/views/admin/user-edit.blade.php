...
<script type="text/javascript">
    ...
    userType.onchange = hideLecturerOptions;
    document.getElementById("userType").addEventListener('load', hideLecturerOptions());
    document.getElementById("lblLoad").addEventListener('load', setLoadValue(loadVal));

    function hideLecturerOptions(){
        if(userType.value != 0){
            document.getElementById("lecturerOptions").classList.add("collapse");
        } else {
            document.getElementById("lecturerOptions").classList.remove("collapse");
        }
    }
