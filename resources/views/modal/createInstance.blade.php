...
<div class="modal-body pt-0" id="modal-body">
    ...
    <br>
        ...
        <div class="row w-75 mb-3 align-items-center">
            ...
            <div class="col-10">
                <input type="range" name="lecturer_load" class="w-75" id="lecturer_load" min="1" max="100" value="{{ $user->lecturer_load ?? 100 }}" step="1" oninput="setLecturerLoadValue(this.value)" disabled='true'/>
